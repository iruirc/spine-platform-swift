...
struct OrderSnapshot {
    let id: UUID
    @Transformed(MoneyAmountTransformer.self) var total: MoneyAmount
    @Children(LineItemMapper.self) var lines: [LineItemSnapshot]
}
```
...
- You keep adding entity types as the product grows.
